...
import { ActiveFileTableColumns } from '../shared/Helpers'
import { ActiveFilesHeader } from '../features/file-management'
...
<template>
	...
	<Table :data="activeFileTableStore.state.files"
		:columns="ActiveFileTableColumns as TableColumn<Event | ActiveFile>[]"
